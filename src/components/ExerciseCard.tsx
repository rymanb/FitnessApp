    ...
    return (
        <Card className="p-4 mb-6">
            ...
            <View className="flex-row items-center mb-4">
                ...
                <Pressable onPress={() => setShowInfo(true)} className="p-2 mr-1 active:bg-surface-light rounded-full">
                    <Feather name="info" size={18} color="#60a5fa" />
                </Pressable>

                <Pressable onPress={onRemove} className="p-2 active:bg-surface-light rounded-full">
                ...
                <View key={set.id} className="flex-row items-center bg-background rounded-xl mb-2 py-1 px-2 border border-surface/50">
                    ...
                    {onToggleSetStatus && (
                        <Pressable
                            ...
                            className={`w-10 h-10 rounded-lg items-center justify-center ml-1 ${
