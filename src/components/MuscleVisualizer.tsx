...
export default function MuscleVisualizer({ muscles, secondaryMuscles }: MuscleVisualizerProps) {
    ...
    const renderMuscleLayers = (isFront: boolean) => {
        ...
        return (
            <View style={{ width: SLIDE_WIDTH }} className="items-center justify-center py-4">
                ...
                <Text color="muted" variant="caption" className="uppercase mt-4 tracking-widest text-[10px]">
    ...
    return (
        <View style={{ width: SLIDE_WIDTH, alignSelf: 'center' }} className="mb-6 overflow-hidden">
            <ScrollView 
